...
export type Media = Node & {
  ...
  title?: Maybe<Scalars['String']['output']>;
  /** When an operator hid this recording from browsing and search; null means listed */
  unlistedAt?: Maybe<Scalars['DateTime']['output']>;
  updatedAt: Scalars['DateTime']['output'];
};
